document.addEventListener("DOMContentLoaded", () => {
  ...
  newsletterForms.forEach(form => {
    ...
    // Look for .newsletter-msg as a sibling within the same parent container
    // (works for both .hero-newsletter and .blog-newsletter wrappers)
    const msg = form.closest("div, section")?.querySelector(".newsletter-msg")
